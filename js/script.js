...
(function () {
    var translations = {
        ...
        bn: {
            ...
            hero_title_1: "ঔষধ খোঁজা এখন",
            hero_title_2: "দ্রুত, সাশ্রয়ী ও কাছেই।",
            hero_text: "ঔষধ খুঁজুন, সাশ্রয়ী অপশন আবিষ্কার করুন, কাছের ফার্মেসির সাথে সংযুক্ত হন এবং স্মার্ট স্বাস্থ্যসেবা সহায়তা পান \u2014 সব একটি সংযুক্ত প্ল্যাটফর্মে।",
            ...
            problem_title: "ঔষধ খোঁজা এত কঠিন হওয়া উচিত নয়।",
            problem_card1_title: "অনিশ্চিত প্রাপ্যতা",
            problem_card1_text: "ঔষধের প্রাপ্যতা অনিশ্চিত — ফার্মেসিতে গিয়ে দেখা যায় ঔষধ স্টকে নেই।",
            problem_card2_title: "দামের ভিন্নতা",
            problem_card2_text: "একই ঔষধের দাম ফার্মেসি ভেদে অনেক পার্থক্য হতে পারে, সেরা দাম খুঁজে পাওয়া কঠিন।",
            problem_card3_title: "অপ্রয়োজনীয় যাতায়াত",
            problem_card3_text: "কাছেই ঔষধ পাওয়া গেলেও গ্রাহকরা অনেক দূর পর্যন্ত খুঁজতে যান।",
            ...
            problem_card5_text: "নির্ধারিত ঔষধ খেতে ভুলে যাওয়া খুব স্বাভাবিক — আর দূরে থাকা পরিবারের সদস্যরা তা জানতেও পারেন না।",
            ...
            problem_card7_text: "ঔষধ সম্পর্কে সহজ ভাষায় দ্রুত তথ্য ও প্ল্যাটফর্ম ব্যবহারে সাহায্যের উৎস খুব কম।",

            solution_label: "সমাধান",
            solution_title: "ঔষধের সম্পূর্ণ যাত্রার জন্য একটি প্ল্যাটফর্ম।",
            ...
            solution_text: "MediFastBD ঔষধ আবিষ্কার, ফার্মেসি তুলনা, অর্ডার এবং ঔষধ ব্যবস্থাপনাকে একটি প্ল্যাটফর্মে একত্রিত করেছে।",

            acquisition_label: "সাশ্রয়ী ঔষধের অপশন",
            acquisition_title: "আরও স্মার্ট, আরও সাশ্রয়ী সিদ্ধান্ত নিন",
            acquisition_subtitle: "দাম, দূরত্ব ও যাতায়াত খরচের ভিত্তিতে সাশ্রয়ী ঔষধের অপশন খুঁজুন।",
            chain_medicine: "ঔষধ",
            ...
            acquisition_medicine_price: "ঔষধের দাম",
            acquisition_travel_cost: "আনুমানিক যাতায়াত খরচ",
            acquisition_total: "মোট সংগ্রহ খরচ",
            acquisition_text: "MediFastBD প্রাপ্য দাম, ফার্মেসির দূরত্ব, যাতায়াত সময় ও আনুমানিক যাতায়াত খরচ মিলিয়ে ঔষধের অপশন মূল্যায়নে সাহায্য করে — শুধু দামে নয়, পুরো যাত্রা বিবেচনায়।",

            search_label: "ঔষধ সার্চ",
            search_title: "প্রয়োজনীয় ঔষধ খুঁজুন",
            search_subtitle: "এক জায়গা থেকেই ঔষধ খুঁজুন, প্রাপ্য ফার্মেসি ও প্রাসঙ্গিক ঔষধ-তথ্য আবিষ্কার করুন।",
            search_cta: "ওয়েব অ্যাপ এক্সপ্লোর করুন →",

            emergency_badge: "জরুরি ঔষধ মোড",
            emergency_title: "কাছে ঔষধ না পেলে",
            emergency_text: "কাছে প্রয়োজনীয় ঔষধ না পেলে ঔষধের নাম ও প্রয়োজনীয় সময় দিন — MediFastBD ৫ কিমি ব্যাসার্ধের যুক্ত ফার্মেসিগুলোকে অ্যালার্ট পাঠাতে পারে, যাতে তারা গ্রাহকের সাথে যোগাযোগ করতে পারে।",
            emergency_step1: "ঔষধ লিখুন",
            ...
            ai_text: "MediFast AI ঔষধ ও সাধারণ স্বাস্থ্য বিষয়ে দ্রুত, সহজ ভাষায় তথ্য দেয় এবং MediFastBD প্ল্যাটফর্ম ব্যবহারে সাহায্য করে।",
            ai_point1: "💊 ঔষধ ও ব্যবহারবিধি সম্পর্কে জিজ্ঞাসা",
            ...
            ai_chip1: "ঔষধ বিষয়ে প্রশ্ন",
            ai_chip2: "ব্যবহারবিধি",
            ai_chip3: "প্ল্যাটফর্ম সাহায্য",
            ai_placeholder: "ঔষধ সম্পর্কে জিজ্ঞাসা করুন…",
            ai_demo_note: "চিত্রমূলক কথোপকথন।",
            carelink_label: "CareLink",
            carelink_title: "CareLink পরিবারকে যুক্ত রাখে",
            carelink_subtitle: "পরিবারের সদস্য দূরে থাকলেও, নির্ধারিত ঔষধ বারবার মিস হলে CareLink নির্বাচিত কেয়ারগিভারকে জানতে সাহায্য করে।",
            carelink_step1: "ঔষধের রিমাইন্ডার",
            ...
            management_label: "রিমাইন্ডার ও ঔষধের আলমারি",
            management_title: "ঔষধ ম্যানেজ করুন সহজে",
            management_subtitle: "রিমাইন্ডার, খাওয়ার সময়সূচি, ঔষধের স্টক, মেয়াদ ট্র্যাকিং ও নোটিফিকেশন — বারবার ডোজ মিস হলে CareLink কেয়ারগিভার নোটিফিকেশনসহ।",
            management_card1_title: "ঔষধের আলমারি",
            management_card1_text: "ব্যক্তিগত ঔষধের স্টক ম্যানেজ করুন। বাড়িতে কী আছে তার হিসাব রাখুন।",
            management_card2_title: "মেয়াদ ট্র্যাকিং",
            management_card2_text: "মেয়াদ শেষ হতে যাওয়া ঔষধের হিসাব রাখুন। মেয়াদোত্তীর্ণ ঔষধ ব্যবহার এড়িয়ে চলুন।",
            management_card3_title: "স্মার্ট রিমাইন্ডার",
            management_card3_text: "ঔষধের রিমাইন্ডার দিয়ে সময়মতো ঔষধ নিন। কোনো ডোজ মিস করবেন না।",
            ...
            admin_best_medicine: "সর্বাধিক বিক্রিত ঔষধ",
            ...
            business_platform: "MediFastBD",
            business_purchase: "ঔষধ ক্রয়",
            business_commission: "প্ল্যাটফর্ম কমিশন",
            business_text: "MediFastBD একটি স্বচ্ছ প্রতি-ঔষধ কমিশন মডেল সমর্থন করে, যা গ্রাহক, ফার্মেসি এবং প্ল্যাটফর্ম সবার জন্য মূল্য তৈরি করে।",
            ...
            howit_step1_text: "ঔষধ, হাসপাতাল খুঁজুন বা MediFast AI-কে জিজ্ঞাসা করুন।",
            ...
            howit_step4_text: "ঔষধ ও স্বাস্থ্য সহায়তা নিন — রিমাইন্ডার ও CareLink সহ।",
            ...
            customers_card2_title: "ঔষধ সার্চ",
            customers_card2_text: "এক জায়গা থেকে ঔষধ খুঁজুন, প্রাপ্য ফার্মেসি ও প্রাসঙ্গিক তথ্য আবিষ্কার করুন।",
            customers_card3_title: "জরুরি ঔষধ মোড",
            customers_card3_text: "ঔষধ + প্রয়োজনীয় সময় দিলে ৫ কিমির যুক্ত ফার্মেসিতে অ্যালার্ট যায়, তারা যোগাযোগ করে।",
            ...
            customers_card5_title: "MediFast AI",
            customers_card5_text: "ঔষধ ও সাধারণ স্বাস্থ্য বিষয়ে দ্রুত সহজ তথ্য ও প্ল্যাটফর্ম সাহায্য। শুধু তথ্যগত।",
            customers_card6_title: "CareLink",
            ...
            different_subtitle: "শুধু ঔষধ খোঁজার অ্যাপ নয় — একটি সংযুক্ত স্বাস্থ্যসেবা প্ল্যাটফর্ম।",
            different_card1_title: "সাশ্রয়ী সিদ্ধান্ত",
            different_card1_text: "মূল্য, দূরত্ব, ভ্রমণ সময় ও আনুমানিক ভ্রমণ খরচ তুলনা করুন — শুধু ঔষধের দাম নয়।",
            different_card2_title: "ইমারজেন্সি মেডিসিন মোড",
            different_card2_text: "কাছে ঔষধ না পেলে ৫ কিমির মধ্যে সংযুক্ত ফার্মেসিকে সতর্ক করুন।",
            different_card3_title: "CareLink",
            different_card3_text: "রোগী বারবার নির্ধারিত রিমাইন্ডার মিস করলে নির্বাচিত কেয়ারগিভার জানতে পারেন।",
            different_card4_title: "MediFast AI",
            different_card4_text: "দ্রুত ও সহজ ঔষধ তথ্য ও প্ল্যাটফর্ম নির্দেশনা — শুধু তথ্যমূলক সহায়তা।",
            ...
            about_text: "Nexora Labs-এর MediFastBD বাংলাদেশ-কেন্দ্রিক ডিজিটাল স্বাস্থ্য প্ল্যাটফর্ম — গ্রাহক, ফার্মেসি মালিক ও অ্যাডমিনকে যুক্ত করে ঔষধ খোঁজাকে আরও সাশ্রয়ী, দ্রুত ও কাছের করে।",
            ...
            demo_subtitle: "কীভাবে MediFastBD ঔষধ অনুসন্ধান, সাশ্রয়ীতা, ফার্মেসি, AI, ইমারজেন্সি ঔষধ আবিষ্কার, কাছের হাসপাতাল ও কেয়ারগিভার সহায়তাকে এক প্ল্যাটফর্মে সংযুক্ত করে তা অন্বেষণ করুন।",
            ...
            cta_title: "ঔষধ খোঁজা দ্রুত, সাশ্রয়ী ও কাছেই।",
            ...
            footer_tagline: "ঔষধ দ্রুত, সাশ্রয়ী ও কাছেই — Nexora Labs",
